...
function ActualTeamItem({currentChoice, answer, animate}) 
{  
    if (currentChoice.Actual === answer.Actual)
    {
        ...
        {
            return (
                <GoodItem delay={1.2} animate={true}>{currentChoice.Actual}</GoodItem>
            )
        } else 
        {
            return (
        ...
        {
            return (
                <BadItem delay={1.2} animate={true}>{currentChoice.Actual}</BadItem>
            )
        } else {
            return (
