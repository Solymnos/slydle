...
function ArrayContentEndYearItem({currentChoice, answer, animate}) 
{
    if (currentChoice.EndYear === undefined || answer.EndYear === undefined)
    {
        return (
            <></>
        )
...
export default ArrayContentEndYearItem