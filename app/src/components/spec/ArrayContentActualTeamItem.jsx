...
function ArrayContentActualTeamItem({currentChoice, answer, animate}) 
{
    if (currentChoice.Actual === undefined || answer.Actual === undefined)
    {
        return (
            <></>
        )
...
export default ArrayContentActualTeamItem