...
const GameResult = ({result, isVisible, tries, score}) => 
{
  ...
  const handleTwitter = () =>
  {
    let link = `https://x.com/intent/post?text=J'ai participer au slydle.fr du jour et j'ai trouvé le résultat en seulement ${tries.toString()} coups !%0A%0A%23SLYWIN LFL OTP LOL évidemment`
