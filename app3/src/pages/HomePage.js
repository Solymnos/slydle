...
{  
  ...
  return (
    <PageContainer>
        ...
        <HomeTimer />
        <GameResult result={answer} isVisible={user.didItToday} tries={gameItems.length} score={score}/>
        <HomeSearchBar data={choices} gameItems={gameItems} setGameItems={setGameItems} answer={answer} setScore={setScore} setAnimationTrigger={setAnimationTrigger} animationTrigger={animationTrigger}/>
